...
public class ProfileFragment extends Fragment {
    ...
    //initializing the username text view
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ProfileFragmentViewModel model = new ViewModelProvider(this).get(ProfileFragmentViewModel.class);

        //initializing the observer
        model.getUsername().observe(this, newName -> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //link string text view to the ui
